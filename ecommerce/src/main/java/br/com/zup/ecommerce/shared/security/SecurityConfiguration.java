...
//        http.authorizeRequests().anyRequest().permitAll().and().cors().and().csrf().disable();
    ...
    private static class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint {
        ...
        public void commence(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, AuthenticationException e) throws IOException, ServletException {
            ...
            logger.error("Tentativa de acesso não autorizado registrada. Mensagem {}", e.getMessage());
            httpServletResponse.sendError(HttpServletResponse.SC_UNAUTHORIZED, "vocẽ não tem acesso a esse recurso");
        }
    }
}
